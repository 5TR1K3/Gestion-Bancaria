            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <h4><b>Depósitos</b></h4>
                        <p>Historial de depósitos realizados en sus cuentas bancarias.</p>
                    </div>
                    <div class="col-12 col-md-6">
                    </div>
                    <?php
                    if (isset($_SESSION['idCuentasAll'])) {
                        ...
                        $sql = "SELECT ID, ID_Tipo, ID_cuenta_destino, Fecha, Monto FROM movimientosbancarios WHERE ID_cuenta_destino IN ('$pCuenta','$sCuenta','$tCuenta') AND ID_Tipo = '1' ORDER BY Fecha ASC";
